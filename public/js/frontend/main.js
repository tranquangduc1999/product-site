...
var placeholderText = ['Bạn muốn tìm gì?','Nội thất gỗ', 'Đồ trang trí', 'Đồ dùng vải', 'Đồ dùng văn phòng'];
$('.search-auto').placeholderTypewriter({text: placeholderText});
var evo = {
	clone_item_view: function(product) { 
		var src = Haravan.resizeImage(product.featured_image, 'small');
		if(src == null){
			src = "https://cdn.hstatic.net/themes/200001110831/1001434972/14/noimage.gif?v=131";
		}
		jQuery('<div class="item">'
			   +'<div class="box-image">'
			   +'<a class="image url-product" href="'+product.url+'" title="'+ product.title +'">'
			   +'<img class="image-review" src="' + src +  '" alt="'+ product.title +'" />'
			   +'</a>'
			   +'</div>'
